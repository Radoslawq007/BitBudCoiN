...
class Storage {
    ...
    _initSchema() {
        ...
        // Migracja dla ISTNIEJĄCEJ bazy (kolumny wyżej nie istniały wcześniej) -
        // ALTER TABLE ADD COLUMN jest bezpieczne w SQLite (nie rusza istniejących
        // wierszy/danych). Jeśli kolumna już jest (świeża baza z CREATE TABLE
        // powyżej), rzuci "duplicate column name" - celowo ignorowane.
        for (const col of ["htlcId TEXT", "hashLock TEXT", "timeoutHeight INTEGER", "claimant TEXT", "refundee TEXT", "secret TEXT"]) {
