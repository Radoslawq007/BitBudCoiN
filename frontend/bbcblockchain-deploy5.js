...
class Blockchain {
    constructor() {
        ...
        if (this.storage.hasBlocks()) {
            ...
            // Bezpiecznik przejściowy: najnowszy blok w łańcuchu jeszcze nie
            // niesie ostatniej ręcznej korekty (03.08.2026, moc spadła,
            // trudność OBNIŻONA) - bezwarunkowo, nie jako "dolna granica"
            // (to był mój błąd chwilę wcześniej - obniżenie nigdy by się nie
            // uruchomiło jako "podnieś jeśli za nisko"). Do usunięcia gdy
            // się potwierdzi że nowy blok już to niesie.
            this.difficulty = 178713018037;
        } else {
