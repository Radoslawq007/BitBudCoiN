...
const translations = {
    pl: {
        ...
        join_top_active_label: "Najbardziej aktywni:",
        join_events_suffix: "transakcji",
        ...
        revoffer_moved_heading: "Ta strona się przeniosła",
        revoffer_moved_desc: "Zatwierdzanie i odrzucanie ofert zakupu jest teraz w Portfelu — logujesz się swoim kluczem i podpisujesz decyzję, bez wspólnego hasła.",
        revoffer_moved_btn: "Otwórz portfel →",
        ...
        offers_none_pending: "Brak oczekujących ofert dla Ciebie.",
        wallet_confirm_new_address: "Potwierdź nowy adres",
        wallet_new_address_warning: "To nowy adres, którego nie masz zapisanego. Sprawdź go dokładnie:",
        wallet_save_contact_prompt: "Zapisać ten adres? Podaj nazwę (zostaw puste, żeby pominąć):",
    ...
    en: {
        ...
        join_top_active_label: "Most active:",
        join_events_suffix: "transactions",
        ...
        revoffer_moved_heading: "This page has moved",
        revoffer_moved_desc: "Approving and rejecting purchase offers now lives in the Wallet — log in with your key and sign the decision, no shared password.",
        revoffer_moved_btn: "Open wallet →",
        offers_heading: "📋 Purchase offers for you",
        offers_intro: "Offers where you're the designated seller — accept/reject by signing with this wallet, no password.",
        offers_load_btn: "Load offers",
        offers_none_pending: "No pending offers for you.",
        wallet_confirm_new_address: "Confirm new address",
        wallet_new_address_warning: "This is a new address you don't have saved. Check it carefully:",
        wallet_save_contact_prompt: "Save this address? Enter a name (leave empty to skip):",
